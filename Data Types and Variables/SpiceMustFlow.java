...
// It must be extracted from the scorching sands of Arrakis, under the constant threat
// of giant sandworms. The Duke has tasked you with creating management software
// to make the work as efficient as possible.
//Write a program that calculates the total amount of spice extracted from a source.
// The source has a starting yield, which indicates how much spice can be mined on the
// first day. After it has been mined for a day, the yield drops by 10,
...
//The mining crew consumes 26 spices every day at the end of their shift and
// an additional 26 after the mine has been exhausted.
