...
//So, the developers made Pokémon Don't Go out of depression.
//And so, Ely now plays Pokémon Don't Go. In Pokémon Don't Go,
//when you walk to a certain Pokémon, those closest to you naturally get further,
//and those further from you get closer.

//You will receive a sequence of integers, separated by spaces - the distances to
//the Pokémons. Then you will begin receiving integers corresponding to indexes
//in that sequence.

//When you receive an index, you must remove the element at that index
//from the sequence (as if you've captured the Pokémon).

//You must INCREASE the value of all elements in the sequence which are LESS or
...
// nd COPY the last element to its place.
...
//The program ends when the sequence has no elements (there are no Pokémons left
// for Ely to catch).
...
//When the program ends, you must print the summed up value of all REMOVED
